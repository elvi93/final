...
// allowing us to add, complete, delete, update, and filter tasks by user ID.
...
export const useTaskStore = defineStore("taskStore", () => {
  ...
  */
  ...
  /**
   * Updates a specific task in the tasks array.
  ...
  /*
  The updateTaskInStore function is used to update a specific task in the tasks array.
  - It takes an updatedTask object as a parameter.
  - It finds the index of the task in the tasks array that has the same id as the updatedTask.
  - If a task with the specified id is found (index is not -1), it replaces the task with the updatedTask.
  - This function allows for updating the details of a task.
  */
...
functions to add, mark as completed, delete, update, and filter tasks by user ID. The state management is reactive, ensuring that 
